...
export const ar = {
  ...
  categories: {
    ...
    descriptions: {
      ...
      other: 'تعليقات عامة لا تنتظر ردًا ولا تحتاج متابعة.',
    },
    samples: {
      ...
      positive: 'القهوة وصلت اليوم والرائحة خيالية 🤎 شكرًا لكم.',
      spam: 'متابعين حقيقيين بأرخص الأسعار 🔥 تواصل خاص.',
      other: 'وش اسم الأغنية في الفيديو؟',
    },
    hiding: {
